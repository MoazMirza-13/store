    ...
    <>
      ...
      <div className="bg-[#D4B78F] flex flex-col items-center mt-20 gap-12 p-12">
        <m.h1
          ...
          className="font-playfair font-bold  sm:text-6xl text-[2.5rem] sm:leading-[4.563rem] leading-[2.5rem] text-center lg:text-start"
        >
          ...
          >
            ...
            >
              ...
              <m.path
                initial={{ pathLength: 0, opacity: 0 }}
                animate={{ pathLength: 1, opacity: 1 }}
                transition={{ duration: 2.8, delay: 0, ease: "easeInOut" }}
